...
class Swiftris{
    ...
    func newShape() -> (fallingShape: Shape?, nextShape: Shape?) {
        ...
        if detectIlegalPlacement() {
            nextShape = fallingShape
            nextShape!.moveTo(PreviewColumn, row: PreviouRow)
            endGame()
            return (nil, nil)
        }
    ...
    func detectIlegalPlacement() -> Bool {
    ...
    func dropShape() {
        if let shape = fallingShape {
            while detectIlegalPlacement() == false {
